...
public class BlueSide5Spec extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder spec1i = drive.actionBuilder(new Pose2d(40, -43, Math.toRadians(-55)))
                .strafeToLinearHeading(new Vector2d(31,-61.5), Math.toRadians(91));
        ...
        TrajectoryActionBuilder toBar2 = drive.actionBuilder(new Pose2d(31, -63.5, Math.toRadians(90)))
                .strafeToLinearHeading(new Vector2d(-0.5,-28), Math.toRadians(87));
        ...
        // 4th spec
        TrajectoryActionBuilder spec4i = drive.actionBuilder(new Pose2d(-3, -27, Math.toRadians(90)))
        ...
        TrajectoryActionBuilder shift4 = drive.actionBuilder(new Pose2d(-5, -28, Math.toRadians(90)))
                .strafeTo(new Vector2d(-5,-28));
        Action back4 = shift4.build();

        // park
        TrajectoryActionBuilder goPark = drive.actionBuilder(new Pose2d(-5, -28, Math.toRadians(90)))
        ...
        Action slidesHang1 =createMotorAction(slides,-295,1,5);
        Action slidesHang2 =createMotorAction(slides,-295,1,5);
        Action slidesHang3 =createMotorAction(slides,-295,1,5);
        Action slidesHang4 =createMotorAction(slides,-295,1,5);
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        new ParallelAction(new SequentialAction(new SleepAction(0.3),new ParallelAction(bar1, outtakeRotation.outtakeRotSpec())),
                                slidesPartUp1),
                        ...
                        new ParallelAction(wall2, outtakeRotation.outtakeRotWall(),
                                new SequentialAction(new SleepAction(0.7),
                                        ...
                                        outtakeClaw.closeClaw(),
                                        new SleepAction(0.1))),
                        new ParallelAction(new SequentialAction(new SleepAction(0.3),new ParallelAction(bar2, outtakeRotation.outtakeRotSpec())),
                                slidesPartUp2),
                        ...
                        new ParallelAction(new SequentialAction(new SleepAction(0.3),new ParallelAction(bar3, outtakeRotation.outtakeRotSpec())),
                                slidesPartUp3),
                        ...
                        new ParallelAction(new SequentialAction(new SleepAction(0.3),new ParallelAction(bar4, outtakeRotation.outtakeRotSpec())),
                                slidesPartUp4),
                        new ParallelAction(slidesHang4, new SequentialAction(new SleepAction(0.35),back3, new SleepAction(0.1),outtakeClaw.openClaw())),
