...
@Config
@Autonomous(name = "5 spec for comp")
public class BlueSideObservation extends LinearOpMode {
        ...
        public Action outtakeRotSpec() {
            return new SequentialAction(
                    new Action(){
                        @Override
                        public boolean run(@NonNull TelemetryPacket packet) {
                            outtakeRotation.setPosition(0.58);
                            return false;
                        }}, new SleepAction(0.1)
            );
        }
    ...
    public void runOpMode() {
        ...
        MecanumDrive drive = new MecanumDrive(hardwareMap, new Pose2d(6, -62, Math.toRadians(90)));
        ...
        int slowVelocity = 60;
        // preload
        TrajectoryActionBuilder tab1 = drive.actionBuilder(new Pose2d(6,-62,Math.toRadians(90)))
                .strafeTo(new Vector2d(-18,-27));
        Action preload=tab1.build();

        // 1st sample
        TrajectoryActionBuilder spec1 = drive.actionBuilder(new Pose2d(-18, -27, Math.toRadians(90)))
                .lineToY(-30)
                .splineToLinearHeading(new Pose2d(28, -44, Math.toRadians(51)), Math.toRadians(90));
        Action intake1 = spec1.build();

        TrajectoryActionBuilder spec1d = drive.actionBuilder(new Pose2d(28, -44, Math.toRadians(51)))
...
//
        ...
        Action slidesHang3 =createStayingMotorAction(slides,-535,1,2);
        Action slidesHang4 =createStayingMotorAction(slides,-535,1,2);
