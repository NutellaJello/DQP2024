...
@Config
@Autonomous(name = "Basket Vision")
public class BlueSideSamplesVision extends LinearOpMode {
...
//
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(new Pose2d(-37,-60,Math.toRadians(90)))
                            ...
                            public boolean run(@NonNull TelemetryPacket packet) {
                                while (opModeIsActive()) {
                                    ...
                                    if (result != null && result.isValid()){
                                        ...
                                        relY = (5.76 * Math.pow(1.0725, ty)) - 6.418;
                                        relX = (1 + (0.157143 * (relY + 6.418))) * (0.159396) * (tx - 17.28) + 4.8;
                            ...
                            public boolean run(@NonNull TelemetryPacket packet) {
                                Actions.runBlocking(
                                        drive.actionBuilder(drive.pose)
                                                .strafeTo(new Vector2d(-40 + relX, -40 + relY))
                                                .build()
                                );
                                return false;
                            }
