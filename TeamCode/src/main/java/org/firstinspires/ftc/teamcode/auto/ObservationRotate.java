...
@Autonomous
@Disabled
public class ObservationRotate extends LinearOpMode {
...
// actions for tranfering and strafing
        ...
        TrajectoryActionBuilder spec1prt2 = drive.actionBuilder(new Pose2d(41.75, -47, Math.toRadians(75)))
                .turnTo(Math.toRadians(340));
        Action firstSampleObservation = spec1prt2.build();

        TrajectoryActionBuilder spec2 = drive.actionBuilder(new Pose2d(41.75, -47, Math.toRadians(340)))
                .turnTo(Math.toRadians(75));
        Action secondSample = spec2.build();

        TrajectoryActionBuilder spec2prt2 = drive.actionBuilder(new Pose2d(41.75, -47, Math.toRadians(75)))
                .turnTo(Math.toRadians(340));
        Action secondSampleObservation = spec2prt2.build();

        TrajectoryActionBuilder spec3 = drive.actionBuilder(new Pose2d(41.75, -47, Math.toRadians(340)))
                .turnTo(Math.toRadians(63));
        Action thirdSample = spec2.build();

        TrajectoryActionBuilder spec3prt2 = drive.actionBuilder(new Pose2d(41.75, -47, Math.toRadians(63)))
                .turnTo(Math.toRadians(340));
        Action thirdSampleObservation = spec2prt2.build();
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        new ParallelAction(
                                new SequentialAction(intakeClaw.closeClaw(),
                                        intakeRotation.intakeRotPartialUp()),
                                intakeSlides.retractPosition()
                        ),
                        firstSampleObservation,
                        new SleepAction(1),
                        secondSample,
                        new SleepAction(1),
                        secondSampleObservation
